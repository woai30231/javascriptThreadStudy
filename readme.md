...
* 为了说明这个问题，我们需要一个实例来说明一下，下面是实例的节选代码，全部代码可到[demo1.html](./tree/master/html/demo1.html)!我们这里实现一个操作：用js实现向页面添加20000*6的一个表格，并且每个单元格需要显示当前的序号，我们知道反复对html进行dom操作、渲染是一个很影响性能的过程，查看页面就知道很卡，而且还可能死机等情况！话不多说，代码如下：
